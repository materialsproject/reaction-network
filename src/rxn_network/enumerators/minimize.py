    ...
    def __init__(
        ...
        Args:
            ...
            exclusive_precursors: Whether enumerated reactions are required to have
                ...
                from the provided precursors. exclusive_targets: Whether enumerated
                reactions are required to have products that are a subset of the
                provided list of targets. If False, (the default), this identifies all
                reactions containing at least one composition from the provided list of
                targets (and any number of byproducts).
            ...
            filter_by_chemsys: An optional chemical system for which to filter produced
                ...
                one element within the provided system. chunk_size: The minimum number
                of reactions per chunk procssed. Needs to be sufficiently large to make
                parallelization a cost-effective strategy. Defaults to MIN_CHUNK_SIZE.
            max_num_jobs: The upper
                limit for the number of jobs created. Defaults to MAX_NUM_JOBS.
            ...
            removing a reactant/product or
                having it change sides. This is also advisable for ensuring that only
                unique reaction sets are produced. Defaults to True.
            max_num_constraints: The maximum number of allowable
                constraints enforced by reaction balancing. Defaults to 1 (which is
                usually advisable).
