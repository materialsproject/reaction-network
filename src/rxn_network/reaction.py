...
Credit goes to the original authors (Shyue Ping Ong and Anubhav Jain) for their work
in developing the majority of this module.
"""
...
class Reaction(BalancedReaction):
    ...
    def _balance_coeffs(self, comp_matrix, max_num_constraints):
        ...
        return balanced, np.squeeze(best_soln)
